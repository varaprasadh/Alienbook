<template>
  <div class="notification-wrapper" v-click-outside="()=>menuopen=false">
      <div :class="['card notification',{unread:!notification.read}]" @click="handleClick">
         <div class="icon">
         ...
         <div class="delete-icon" v-click-outside="()=>menuopen=false" @click.stop="menuopen=!menuopen">
            <MenuOptionIcon/>
