<template>
   <transition-group name="liked" mode="out-in">
      ...
      <template v-else>
         <div class="react-wrapper" key="1" v-if="reaction.type==='LIKE'">
         ...
         <div class="react-wrapper" key="3" v-if="reaction.type==='LOVE'">
            <img class="icon love" src="../assets/reactions/love.svg"  alt="love">
         </div>
         <div class="react-wrapper" key="4" v-if="reaction.type==='CARE'">
            <img class="icon care"  src="../assets/reactions/care.svg"  alt="care">
         </div>
         <div class="react-wrapper" key="5" v-if="reaction.type==='HAHA'">
            <img class="icon haha"   src="../assets/reactions/haha.svg"  alt="haha">
         </div>
         <div class="react-wrapper" key="6" v-if="reaction.type==='WOW'">
            <img class="icon wow" src="../assets/reactions/wow.svg"   alt="wow">
         </div>
         <div class="react-wrapper" key="7" v-if="reaction.type==='ANGRY'">
