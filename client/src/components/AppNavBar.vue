     ...
     <nav class="main-nav">
       <div class="nav-container">
           ...
           <div class="nav-group sm-bottom">
               ...
               <div class="nav-item notifications" :class="{active:currentPage==='/notifications'}">
               ...
               <div class="nav-item settings" :class="{active:currentPage==='/settings'}">
